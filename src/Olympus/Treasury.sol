...
contract TheopetraTreasury is Ownable {
    ...
    uint256 public sTHEOQueue; // Delays change to sTHEO address
    ...
    function incurDebt(uint256 _amount, address _token) external {
        ...
        uint256 maximumDebt = IERC20(sTHEO).balanceOf(msg.sender); // Can only borrow against sTHEO held
    ...
    function queue(MANAGING _managing, address _address) external onlyManager returns (bool) {
        ...
        } else if (_managing == MANAGING.STHEO) {
            // 9
