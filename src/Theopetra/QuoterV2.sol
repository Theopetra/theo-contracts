...
contract QuoterV2 is IQuoterV2, IUniswapV3SwapCallback, PeripheryImmutableState {
    ...
    constructor(address _factory, address _WETH9) PeripheryImmutableState(_factory, _WETH9) {
        console.log("QuoterV2 constructor");
        console.log("Factory: %s", _factory);
        console.log("WETH9: %s", _WETH9);
    }
...
//        console.log('sqrtPriceX96After %s', sqrtPriceX96After);
//        console.log('initializedTicksCrossed %s', initializedTicksCrossed);
